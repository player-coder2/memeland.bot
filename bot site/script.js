...
var users = {
  phineas: {
    ...
    avatar:
      "https://cdn.discordapp.com/avatars/94490510688792576/a_46a9fccf4764d0311943d875cdc07128.webp?size=128",
  },
  paragon: {
    username: "Paragon",
    ...
    bot: true,
    avatar:
      "https://cdn.discordapp.com/avatars/273591274899111937/fe783607823a2028988b1a4bc26cfe3e.webp?size=128",
  },
};
        ...
        embedData: {
          ...
          fields: [
            ...
            },
            {
              name: "-> Lookup/Utility",
              value:
                "socialblade, snapcode, image, translate, langdetect, github, twitter, ipinfo, calculate, btcprice",
            },
            {
              name: "-> Fun",
            ...
            },
            {
              name: "-> Management",
              value:
                "beta, guser, deploy-git-release, datasearch, dbstats, add-shard, sAnnounce, reqinv, add-zone-record, get-msg",
            },
          ],
        },
      },
    ...
    messages: [
      ...
      },
      {
        ...
        embedData: {
          ...
          pill: "hsl(202, 35%, 68%)",
          thumb:
            "https://images-ext-2.discordapp.net/external/Zdj-EIYZixh-NSFIQrmwLq6wn8RjzwEk4Hebb--Mryk/https/i.ytimg.com/vi/KOgvA98FifU/hqdefault.jpg?width=80&height=60",
          fields: [
            {
              name: "Now Streaming",
...
function scrollMessages() {
  ...
  var endY =
    demoEle.messages.scrollHeight - demoEle.messagesWrapper.clientHeight;
...
function createEmbed(embed, embedData) {
  var _embedData$title = embedData.title,
    ...
    pillColor =
      _embedData$pill === undefined ? "hsl(0, 0%, 50%)" : _embedData$pill,
    _embedData$footerIcon = embedData.footerIcon,
    footerIconURL =
      _embedData$footerIcon === undefined ? "" : _embedData$footerIcon,
  ...
  var footerContainer = createElement({
    parent: rich,
    style: { height: footerText ? "18px" : "0px" },
  });
  var footerIcon = createElement({
    tagName: "img",
  ...
  if (footerIconURL) {
    footerIcon.onload = function () {
      return (
        (footerIcon.width = footerIcon.naturalWidth),
        (footerIcon.height = footerIcon.naturalHeight)
      );
    };
  ...
  var innerContent = createElement({
  ...
  if (thumbURL) {
    thumb.onload = function () {
      return (
        (thumb.width = thumb.naturalWidth), (thumb.height = thumb.naturalHeight)
      );
    };
    thumb.src = thumbURL;
...
function createMessageGroup() {
  ...
  var usernameWrapper = createElement({
  ...
  var result = text.replace(
    ...
    function (match, tag, attributes) {
      ...
      if (typeof attributes !== "number") {
        ...
        if (tag === "emoji") {
          ret =
            '<img class="emoji" src="https://twemoji.maxcdn.com/2/svg/' +
            attr.id.toLowerCase() +
            '.svg">';
        } else if (tag === "strong") {
...
function createElement() {
  ...
  if (typeof classes === "string" && classes.length) {
    ...
    (_ele$classList = ele.classList).add.apply(
      _ele$classList,
      _toConsumableArray(
  ...
  if (text) {
    ...
    var _ref2 = hasBrackets ? parseBrackets(text) : {},
      ...
      changedBrackets =
        _ref2$changedBrackets === undefined ? false : _ref2$changedBrackets;
